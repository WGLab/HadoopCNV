...
/**
 * @return The fully qualified BAM path on HDFS. Can be a wildcard
 * for multiple BAMs.
 */
...
/**
 * @return Should we run the global sort component? This sorts the depth calls
 * over all bases.
 */
...
/**
 * @return The number of Reducers to be used for all components except
 * the depth caller
 */
